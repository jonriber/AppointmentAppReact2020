...
class AddAppointments extends Component {
    ...
    handleAdd(e) {
        e.preventDefault(); //preventDefault is a way to force the page not to reload automaticaly after someone submit the form
        let tempApt = {
                ...
                <div className='card-body'>
                    <form id='aptForm' noValidate onSubmit={this.handleAdd}>
                        ...
                        <div className='form-group form-row'>
                            ...
                            htmlFor='petName' readOnly>
                                Pet Name
                            </label>
                            <div className='col-md-10'>
                                <input type='text' className='form-control' name='petName' placeholder='Pet´s Name' value={this.state.petName}
